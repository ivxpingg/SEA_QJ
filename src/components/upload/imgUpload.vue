<template>
    <div class="img-upload">
        ...
        <Modal title="查看图片" v-model="visible" class="img-modal-view">
...
<script>
    ...
    import Config from '../../../src/libs/appConfig/config';
    import Cookie from '../../../src/libs/helpers/cookies';
    export default {
        data() {
            return {
                uploadList: [],              // 上传图片信息
                visible: false,              // 浏览图片弹出窗隐藏/显示
                url: '/sys/upload/file',  // 请求地址
                headers: {},                 // 请求的头部信息
        ...
        computed: {
            actionUrl () {
                ...
                return window.location.origin + Config[Config.env].ajaxUrl  + this.url;
            }
        },
        mounted () {
